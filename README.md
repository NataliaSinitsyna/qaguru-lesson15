...
# Проект по автоматизации тестирования для компании [РТЛабс](https://www.x5.ru/ru/)

> РТ Лабс — эксперт в создании масштабных цифровых сервисов, развивает высоконагруженные системы электронного правительства: Госуслуги, цифровой ассистент робот Макс, ЕСИА, СМЭВ, мобильные приложения семейства Госуслуг и другие проекты.
...
____
- ✓ *Успешное прохождение услуги по получению справки об отсутствии судимости*
- ✓ *Успешное прохождение услуги по получению выписки из СФР*
- ✓ *Успешное прохождение услуги по получению ИНН*
...
____
<p align="center">  
<a href="https://jenkins.autotests.cloud/job/21-nsinitsyna-hw15/"><img src="images/screen/jenkins_build.png" alt="Jenkins" width="950"/></a>  
</p>
...
___
<a id="allure"></a>
## <img alt="Allure" height="25" src="images/logo/Allure.svg" width="25"/></a> <a name="Allure"></a>Allure [отчет](https://jenkins.autotests.cloud/job/21-nsinitsyna-hw15/allure/)</a>
___
...
<p align="center">  
<img title="Allure TestOps Tests" src="images/screen/allure_autotests.png" width="850">  
</p>
...
____
<p align="center">
<img title="Selenoid Video" src="images/video/rtlabs.gif" width="550" height="350"  alt="video">   
</p>
